...
addEventSubmit.addEventListener("click", () => {
  ...
  if (eventTitle === "") {
    alert("Please fill the event title");
    return;
    if (eventTimeFrom === "") {
        eventTimeFrom = "--:--";
      }
  ...
  // If event time is empty, default to 00:00 for both
const timeFrom = eventTimeFrom === "" ? "00:00" : eventTimeFrom;
const timeTo = eventTimeTo === "" ? "00:00" : eventTimeTo;

// Check for correct time format (24-hour)
const timeFromArr = timeFrom.split(":");
const timeToArr = timeTo.split(":");

// Ensure the time is in the correct format and valid
if (
